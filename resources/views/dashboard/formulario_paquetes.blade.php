...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="POST" action="{{route('Paquetes_post')}}" enctype="multipart/form-data">
@csrf
                                        <div class="form-group">
                                          <label for="exampleInputEmail1">Nombre Paquete</label>
                                          <input type="text" class="form-control" name="Ciudad" id="Ciudad" aria-describedby="emailHelp" placeholder="">
                                         
                                        </div>
                                        <div class="form-group">
                                          <label for="exampleInputPassword1">Descripcion Paquete</label>
                                        ...
                                        <select class="form-select" aria-label="Default select example" name="destino">
                                            ...
                                            <option value="{{$destino->id}}">{{$destino->Ciudad}}</option>
                                            @endforeach
                                          </select>
                                        </div>
                                        <button type="submit" class="btn btn-primary text-center">Guardar Paquete</button>
                                    </form> 
      </div>
